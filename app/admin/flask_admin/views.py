...
class CustomModelView(BaseModelView):
    """
    ...
    def __init__(self, coll,
        ...
        super(CustomModelView, self).__init__(None, name, category, endpoint, url,
    ...
    def update_model(self, form, model):
        ...
        try:
            ...
            self.coll.update_one({'_id': pk}, {'$set': model})
        except Exception as ex:
    ...
    def is_action_allowed(self, name):
        ...
        return super(CustomModelView, self).is_action_allowed(name)
