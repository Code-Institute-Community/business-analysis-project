...
const filteredArray = data.filter(dictionary => naceLvl1.includes(dictionary.Section) && dictionary.Division == null);

const uniqueValues = [...new Set(filteredArray.map(dictionary => dictionary.Activity))];
